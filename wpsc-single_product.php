...
<?php
		...
		while ( wpsc_have_products() ) : wpsc_the_product(); ?>
					<div class="imagecol col-xs-12 col-sm-5">
						<?php if ( wpsc_the_product_thumbnail() ) : ?>
								<a rel="<?php echo wpsc_the_product_title(); ?>" class="<?php echo wpsc_the_product_image_link_classes(); ?>" href="<?php echo esc_url( wpsc_the_product_image() ); ?>">
									<img class="product_image col-xs-12 img-responsive" id="product_image_<?php echo wpsc_the_product_id(); ?>" alt="<?php echo wpsc_the_product_title(); ?>" title="<?php echo wpsc_the_product_title(); ?>" src="<?php echo wpsc_the_product_thumbnail(400, 510); ?>"/>
								</a>
								<?php
...
<!-- bootstrap won't let me do a col 5 and 7, or offset 5 and 6 by 1? -->
					<div class="productcol col-xs-12 col-sm-6">
							...
							<?php if((get_option('hide_addtocart_button') == 0) &&  (get_option('addtocart_or_buynow') !='1')) : ?>
								<?php if(wpsc_product_has_stock()) : ?>
									<div class="wpsc_buy_button_container">
											...
											<?php else: ?>
										<input type="submit" value="<?php _e('Add To Cart', 'wp-e-commerce'); ?>" name="Buy" class="wpsc_buy_button btn btn-primary" id="product_<?php echo wpsc_the_product_id(); ?>_submit_button"/>
											<?php endif; ?>
